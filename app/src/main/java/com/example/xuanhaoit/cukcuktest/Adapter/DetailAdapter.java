...
public class DetailAdapter extends RecyclerView.Adapter<DetailAdapter.ItemHodler> {
    List<Product> list;
    Context context;
    int layout;

    public DetailAdapter(Context context, List<Product> list)
    {
    ...
    public void onBindViewHolder(@NonNull ItemHodler holder, int position) {
        String uriImage = "http://192.168.1.164:8080/img/";
